...
def test_mixed_costs_no_negative_cycle():
    ...
    assert shortest_paths == {1: [2, 4, 3], 2: [], 3: [2, 4], 4: [2]}


def test_positive_costs_only():
    graph = {1: [(2, 1), (3, 1)], 2: [(3, 2), (4, 1)], 3: [(1, 1), (4, 4)], 4: [(3, 3)]}
    ...
    assert shortest_paths == {1: [2, 3], 2: [], 3: [2], 4: [2]}
...
def test_negative_costs_no_negative_cycle():
    graph = {1: [(2, -4), (3, -1), (4, -2)], 2: [(3, -1), (4, -6)], 3: [(4, -3)], 4: []}
